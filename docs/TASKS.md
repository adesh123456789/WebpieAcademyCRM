...
| ACA-001 | P1 / L | Codex | IN_PROGRESS | FND-002, SEC-001 | Versioned graph mappings/questions/tags/source rights, tenant-private content; historical content survives edits, no cross-tenant selection |
| EXM-001 | P0 / L | Codex | READY | ACA-001 | C03; validated profile/blueprint, draft/review/transactional finalize and immutable snapshots; no unapproved AI candidates or invalid totals |
