...
| UI-003 | P1 / L | Antigravity | READY | UI-002, C02 acknowledged | Student/import/parent-link/batch workflows and resumable onboarding; malformed/duplicate CSV and empty states verified |
